...
class ClericalApp:
    ...
    def draw_recordframe(self, config, working_file):
        ...
        # except when matching is completed
            ...
            messagebox.showinfo(title="Matching completed",
        ...
        for n, columnfile_title in enumerate(config.options('columnfile_info_and_order')):
            ...
            header_separator = ttk.Separator(
                self.recordFrame,  orient='horizontal', styl='grey.TSeparator')
    ...
    def save_and_close(self):
        ...
        try:
            ...
            messagebox.showwarning(
                message="This clerical sample is open in another program. To save, please close the other program.")
